...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  if (arguments < 1 || arguments.length === 0) { 
    return 0; 
  }
  var numz = 1;
   for (let i = 0 ; i < arguments.length ; i++) {
    numz = numz * arguments[i];
  }
  return numz;
}
...
function empiezaConNueve(n) {
  ...
  if(num.charAt(0) === "9"){
    return true
  } //tuve que buscar solucion en github ya que realmente no supe como realizarlo, no he visto esta clase
  return false
}
